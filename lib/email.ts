...
export const emailTemplates = {
  ...
  paymentReceived: (amount: number, jobTitle: string) => `
    ...
    <p>We have received your payment of AED ${(amount / 100).toFixed(2)} for the application to ${jobTitle}.</p>
    <p>Your application is now being processed.</p>
  `,
  
  refundProcessed: (amount: number) => `
    <h1>Refund Processed</h1>
    <p>A refund of AED ${(amount / 100).toFixed(2)} has been processed to your account.</p>
